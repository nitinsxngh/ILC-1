...
const Mentor = () => {
  ...
  const handleExploreMoreClick = () => {
    window.location.href = 'https://explore.ilc.limited/mentors'; // Redirect to the explore mentors page
  };
  ...
  return (
    <div id="mentors-section" className="mx-auto max-w-2xl pb-16 px-4 sm:py-20 sm:px-6 lg:max-w-7xl lg:px-8">
      <div className="sm:flex justify-between items-center mb-12">
        ...
        <div>
          <button
            onClick={handleExploreMoreClick} // Add onClick handler to button
