...
const Founder: React.FC = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row items-center gap-12 p-8 mx-auto sm:py-36 sm:px-6 lg:max-w-6xl lg:px-8 bg-white border-t-2 border-purple">
      ...
      <div className="flex-grow text-center lg:text-left">
        ...
        <p className="text-gray-700 text-xl font-semibold text-purple-700 mb-4">{designation}</p>
        <p className="text-gray-700 text-xl leading-relaxed italic border-l-4 border-purple pl-4">{thoughts}</p>
      </div>
    </div>
  );
};
